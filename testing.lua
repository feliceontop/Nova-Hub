...
-- if you're just looking to get the library for whatever reason, just copy everything from below till you see LIBRARY END
	...
	local library = {design = getgenv().design == "kali" and "kali" or "uwuware", tabs = {}, draggable = true, flags = {}, title = "NovaWare", open = false, mousestate = inputService.MouseIconEnabled, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "nw_configs", fileext = ".nw"}
	...
	local InnsbruckTab = library:AddTab"Innsbruck"
	local InnsbruckColumn = InnsbruckTab:AddColumn()
	local InnsbruckColumn1 = InnsbruckTab:AddColumn()

	local InnsbruckTabGunMod = InnsbruckColumn:AddSection"Gun Mods"
	local InnsbruckTabTeleports = InnsbruckColumn:AddSection"Teleports"

	InnsbruckTabGunMod:AddButton({text = "PPS-43", callback = function()
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).recoilY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).recoilX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).AspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).AspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).UAspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).UAspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["PPS-43"].Settings).AmmoInClip = math.huge
		game:GetService("Players").LocalPlayer.Backpack["PPS-43"].AmmoLeft.Value = math.huge
	end})

	InnsbruckTabGunMod:AddButton({text = "Scoped Mosin Nagant", callback = function()
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).recoilY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).recoilX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).AspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).AspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).UAspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).UAspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].Settings).AmmoInClip = math.huge
		game:GetService("Players").LocalPlayer.Backpack["Scoped Mosin Nagant"].AmmoLeft.Value = math.huge
	end})

	InnsbruckTabGunMod:AddButton({text = "MG42", callback = function()
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).recoilY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).recoilX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).AspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).AspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).UAspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).UAspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["MG42"].Settings).AmmoInClip = math.huge
		game:GetService("Players").LocalPlayer.Backpack["MG42"].AmmoLeft.Value = math.huge
	end})

	InnsbruckTabGunMod:AddButton({text = "TT-33 ( One-Shot Pistol )", callback = function()
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts.Head = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts["Left Arm"] = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts["Right Arm"] = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts.Torso = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts["Left Leg"] = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).damageParts["Right Leg"] = 100
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).recoilY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).recoilX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).AspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).AspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).UAspreadX = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).UAspreadY = 0
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).AmmoInClip = math.huge
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).minVehiclePen = 9999
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).maxVehiclePen = 9999
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).minVehicleDam = 9999
		require(game:GetService("Players").LocalPlayer.Backpack["TT-33"].Settings).maxVehicleDam = 9999
		game:GetService("Players").LocalPlayer.Backpack["TT-33"].AmmoLeft.Value = math.huge
	end})

	InnsbruckTabTeleports:AddButton({text = "JewleryStoreUtilities", callback = function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-232.087448, 4.64856291, -85.5068817, 0.999610662, 1.83780291e-09, -0.0279027149, 3.86174009e-11, 1, 6.72481306e-08, 0.0279027149, -6.722302e-08, 0.999610662)
	end})

	InnsbruckTabTeleports:AddButton({text = "JewleryStore", callback = function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-137.332397, 17.0891914, 223.763748, 0.00700075971, 5.79594648e-08, -0.999975502, 1.9766345e-08, 1, 5.80992676e-08, 0.999975502, -2.01725996e-08, 0.00700075971)
	end})

	InnsbruckTabTeleports:AddButton({text = "JewleryStoreSell", callback = function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-719.752441, 6.80026197, 242.694611, -0.946652949, -7.24791107e-08, 0.322254896, -7.28536307e-08, 1, 1.08982334e-08, -0.322254896, -1.31605935e-08, -0.946652949)
	end})

--	local City17Tab = library:AddTab"City 17"
--	local City17Column = City17Tab:AddColumn()
--	local City17Column1 = City17Tab:AddColumn()
--
--	local City17Main = City17Column1:AddSection"Main"
--	local City17Player = City17Column1:AddSection"Player"
--	local City17Misc = City17Column1:AddSection"Misc"
--	local City17GunMod = City17Column:AddSection"Gun Mods"
--	local City17Shop = City17Column:AddSection"Shop"
--
--	City17Main:AddButton({text = "Disable Kick AntiCheat", callback = function()
--		local old
...
--		end))
--	end})
--	City17Main:AddButton({text = "Spawn w Pistol and Medkit", callback = function()
--		local args = {
--			[1] = {
...
--		}
--		
--		game:GetService("ReplicatedStorage").GalacticTech.Remotes.CompleteCharacter:FireServer(unpack(args))
--		
--		local args = {
--			[1] = {
--				["SkinTone"] = Color3.new(0.972549, 0.768627, 0.584314),
...
--				["Hair"] = "Male_01",
--				["IsRebel"] = false,
--				["Morph"] = "REPRESENTATIVE"
--			}
--		}
--		
--		game:GetService("ReplicatedStorage").GalacticTech.Remotes.CompleteCharacter:FireServer(unpack(args))
--	end})
--	City17Main:AddToggle({text = "Factory Autofarm", state = false, callback = function(State)
--		if state then
--			while doFactory == true do
--				game:GetService("ReplicatedStorage").eTech.Remotes.FactoryStartWorking:FireServer(workspace.ProductionLines.ProductionLine)
--				game:GetService("ReplicatedStorage").eTech.Remotes.FactoryProgress:FireServer()
--				wait()
--			end
--		end
--	end})
--	City17Main:AddToggle({text = "Auto Heal", state = false, callback = function(State)
--		if state then
--			while state == true do
--				game:GetService("ReplicatedStorage").eTech.Remotes.FactoryStartWorking:FireServer(workspace.ProductionLines.ProductionLine)
--				game:GetService("ReplicatedStorage").eTech.Remotes.FactoryProgress:FireServer()
...
--	end})
--	
--	City17Player:AddButton({text = "Suicide", callback = function()
--		game:GetService("Players").LocalPlayer.Character:Destroy()
--	end})
--
--	City17Misc:AddButton({text = "Start Infinite Yield", callback = function()
--		loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
--	end})
--
--	City17GunMod:AddButton({text = "USP Match", callback = function()
--		game:GetService("Players").LocalPlayer.Backpack["USP Match"].BlasterSettings.Stats.Spread.Value = 0
--		game:GetService("Players").LocalPlayer.Backpack["USP Match"].BlasterSettings.Animations.Reload:Destroy()
--		game:GetService("Players").LocalPlayer.Backpack["USP Match"].Animations.Equip:Destroy()
--	end})
--	City17GunMod:AddButton({text = "Colt Python", callback = function()
--		game:GetService("Players").LocalPlayer.Backpack["Colt Python"].BlasterSettings.Stats.Spread.Value = 0
--		game:GetService("Players").LocalPlayer.Backpack["Colt Python"].BlasterSettings.Animations.Reload:Destroy()
--		game:GetService("Players").LocalPlayer.Backpack["Colt Python"].Animations.Equip:Destroy()
--	end})
--	City17GunMod:AddButton({text = "SMG", callback = function()
--		game:GetService("Players").LocalPlayer.Backpack["SMG"].BlasterSettings.Stats.Spread.Value = 0
--		game:GetService("Players").LocalPlayer.Backpack["SMG"].BlasterSettings.Animations.Reload:Destroy()
--		game:GetService("Players").LocalPlayer.Backpack["SMG"].Animations.Equip:Destroy()
--	end})
--	City17GunMod:AddButton({text = "SPAS-12", callback = function()
--		game:GetService("Players").LocalPlayer.Backpack["SPAS-12"].BlasterSettings.Animations.Reload:Destroy()
--		game:GetService("Players").LocalPlayer.Backpack["SPAS-12"].Animations.Equip:Destroy()
--	end})
--	City17GunMod:AddButton({text = "Crossbow", callback = function()
--		game:GetService("Players").LocalPlayer.Backpack["Crossbow"].BlasterSettings.Stats.Spread.Value = 0
--		game:GetService("Players").LocalPlayer.Backpack["Crossbow"].BlasterSettings.Animations.Reload:Destroy()
--		game:GetService("Players").LocalPlayer.Backpack["Crossbow"].Animations.Equip:Destroy()
--	end})
--
--	City17Shop:AddButton({text = "USP Match", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "USP Match"
--		}
--		
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "Colt Python", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "Colt Python"
--		}
...
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "SMG", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "SMG"
--		}
...
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "SPAS-12", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "SPAS-12"
--		}
...
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "Crossbow", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "Crossbow"
--		}
...
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "Health Vial", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "Health Vial"
--		}
...
--		game:GetService("ReplicatedStorage").eTech.Remotes.PurchaseHandler:InvokeServer(unpack(args))
--	end})
--	City17Shop:AddButton({text = "Crowbar", callback = function()
--		local args = {
--			[1] = game:GetService("ReplicatedStorage").eTech.Info.Shops:FindFirstChild("Gun Shop"),
--			[2] = "Crowbar"
--		}
